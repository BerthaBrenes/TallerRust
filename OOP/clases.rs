...
impl Rectangulo{// le implementa un metodo a la estructura rectangulo
    pub fn area(&self) -> i32{// self hace referencia a la esctructura, y pub indica que es publico
...
impl std::fmt::Display for Rectangulo{ //de esta forma logro visualizar todos los datos de la funcion Rectangu;p
